		...
		<>
			...
			<div className="relative z-10 bg-black shadow-gray-500 dark:shadow-none shadow-xl">
				...
				<section className="flex flex-col justify-center items-center h-[65vh]">
					<h1 className="font-bold text-6xl mb-10 text-white">ברוכים הבאים</h1>
					<p className="w-1/2 font-semibold text-xl text-white dark:text-gray-200">
			...
			<section className="flex p-10 bg-gray-100 dark:bg-neutral-900 gap-10 break-words">
				<article className="flex-1 p-2 pb-0 min-w-0">
					<h2 className="font-bold text-2xl text-slate-500 dark:text-slate-300 mr-10 mb-10 text-center">
						התקפת הבוקר היומית
					</h2>
				...
				<div className="flex-1 p-2 pb-0 min-w-0">
					...
					<ol className="flex flex-col gap-2">
						{[...Array(30)].map((_n, i) => (
							...
							>
								...
								<p className="bg-indigo-100 dark:bg-indigo-900 rounded-md px-2 py-1">איתי ברוק</p>
