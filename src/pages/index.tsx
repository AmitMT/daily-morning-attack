...
const Index: NextPage<PageProps> = ({ cyberAttacks, latestCyberAttack }) => {
	...
	return (
		<>
			...
			<section className="flex flex-col-reverse lg:flex-row pt-10 lg:p-10 bg-gray-100 dark:bg-neutral-900 gap-10 break-words">
				<article className="lg:flex-1 dark:bg-neutral-900 rounded-xl overflow-hidden border-4 dark:border-none m-2 lg:m-0">
